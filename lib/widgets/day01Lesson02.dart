    ...
    return SingleChildScrollView(
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(
            'countable nouns යනු ගැනිය හැකි නාම පද වේ. මේවා ඒක වචන හා බහුවචන ලෙස ආකාර 2කි. ඉදිරියේදී ඉතා පැහැදිලිව ඒකවචන හා බහුවචන නාමපද ගැන පැහැදිළි පාඩමක් එකතු කර ඇත.',
            style: TextStyle(
              fontSize: size,
              color: Colors.black,
            ),
